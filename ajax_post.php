...
if (isset($_FILES['upfile']) && $_FILES['upfile']['error'] == 0) {
    ...
    if (is_uploaded_file($tmp_path)) {
        if (move_uploaded_file($tmp_path, $file_name)) {
            ...
            $sql = 'INSERT INTO episode_table(id,manufacturer,product,image,comment,indate)VALUES(NULL,:a1,:a2,:image,:a3,sysdate())';
        } else {
    ...
    $sql = 'INSERT INTO episode_table(id,manufacturer,product,image,comment,indate) VALUES(NULL,:a1,:a2,NULL,:a3,sysdate())';
}
...
$stmt->bindValue(':a1', $manufacturer, PDO::PARAM_STR);
